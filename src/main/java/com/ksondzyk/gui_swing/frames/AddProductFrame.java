...
/*
    ...
    private void createProductButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!Storage.productsGroups.contains(product.getGroupID())) {
            Storage.productsGroups.add(new ProductGroup(product.getGroupID(),category));
            StorageFrame.addProductGroup(category);
        }
